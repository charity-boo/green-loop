            ...
            <section className="relative py-32 bg-slate-900 text-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        >
                            <span className="inline-block px-4 py-1.5 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-full text-sm font-bold tracking-widest uppercase">
                                Computer Vision Core
                            </span>
                            <h1 className="text-5xl md:text-7xl font-black leading-[1.1] tracking-tight">
                                Smarter Sorting <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-blue-400">Powered by AI</span>
                            </h1>
                            <p className="text-xl text-slate-400 leading-relaxed font-medium">
                                We utilize advanced TensorFlow models to classify waste in real-time. Simply snap a photo, and our neural network identifies materials with over 90% accuracy, providing instant disposal guidance.
                            </p>
                            <div className="flex flex-wrap gap-4 pt-4">
                                ...
                                <button className="px-10 py-5 bg-slate-800 text-white font-black rounded-2xl hover:bg-slate-700 transition flex items-center gap-3 transform hover:-translate-y-1">
                        ...
                        >
                            <div className="relative z-10 rounded-[3rem] overflow-hidden border border-slate-700 shadow-[0_0_100px_-20px_rgba(16,185,129,0.2)] bg-slate-800 group" style={{ height: '550px' }}>
                                ...
                                <div className="absolute top-10 left-10 p-4 bg-slate-900/80 backdrop-blur-md rounded-2xl border border-white/10 space-y-3 animate-pulse">
                                    <div className="flex items-center gap-3">
                                        <div className="w-3 h-3 bg-emerald-500 rounded-full shadow-[0_0_10px_#10b981]"></div>
                                        <span className="text-[10px] font-bold uppercase tracking-widest text-emerald-400">Processing Scan...</span>
                                    </div>
                                    <div className="h-1.5 w-32 bg-slate-700 rounded-full overflow-hidden">
                                        <div className="h-full w-2/3 bg-emerald-500 animate-[loading_2s_ease-in-out_infinite]"></div>
                                    </div>
                                </div>
                            </div>

                            {/* Floating Tech Badges */}
                            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-3xl shadow-2xl z-20 border border-slate-100 text-slate-900 hidden md:block">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-[10px] text-slate-500 font-bold mt-1 uppercase">Proprietary Training</div>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                ...
                <div className="absolute top-0 right-0 w-[1000px] h-[1000px] bg-emerald-500/10 rounded-full blur-[150px] -translate-y-1/2 translate-x-1/2"></div>
                <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-blue-500/5 rounded-full blur-[120px] translate-y-1/2 -translate-x-1/2"></div>
            </section>
            ...
            <section className="py-32 bg-white relative">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-24">
                        <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6">Four Layers of Logic</h2>
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto font-medium">Our classification engine works through a multi-stage validation process to ensure data integrity.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={i} className="p-10 rounded-[3rem] bg-slate-50 border border-slate-100 hover:bg-emerald-600 transition-all duration-500 group">
                                ...
                                <p className="text-slate-600 leading-relaxed font-medium group-hover:text-emerald-50 transition-colors">{item.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
                        ...
                        <div className="lg:w-1/2">
                            <div className="grid grid-cols-2 gap-6">
                                <div className="space-y-6">
                                    <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 transform hover:-rotate-2 transition-transform">
                                        <BarChart3 className="w-10 h-10 text-blue-500 mb-4" />
                                        <div className="text-3xl font-black text-slate-900">1.2M+</div>
                                        <p className="text-sm font-bold text-slate-500 uppercase tracking-widest mt-1">Images Processed</p>
                                    </div>
                                    <div className="bg-emerald-600 p-8 rounded-3xl shadow-xl text-white transform hover:rotate-2 transition-transform">
                                        <History className="w-10 h-10 text-emerald-300 mb-4" />
                                ...
                                <div className="space-y-6 pt-12">
                                    <div className="bg-slate-900 p-8 rounded-3xl shadow-xl text-white transform hover:rotate-2 transition-transform">
                                        <Scan className="w-10 h-10 text-emerald-400 mb-4" />
                                        <div className="text-3xl font-black">0.5s</div>
                                        <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mt-1">Avg. Latency</p>
                                    </div>
                                    <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 transform hover:-rotate-2 transition-transform">
                                        <Cpu className="w-10 h-10 text-purple-500 mb-4" />
                                        <div className="text-3xl font-black">Edge</div>
                                        <p className="text-sm font-bold text-slate-500 uppercase tracking-widest mt-1">Computing Optimized</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-slate-900 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl">
                        <div className="relative z-10 space-y-8">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center gap-6 pt-4">
                                <Link
                                    href="/waste"
                                    className="px-12 py-5 bg-white text-slate-900 font-black rounded-2xl hover:bg-emerald-50 transition transform hover:scale-105 shadow-2xl"
                                >
                                    Open Classifier
                                </Link>
                                <Link
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[20rem] font-black text-emerald-500/5 pointer-events-none uppercase tracking-tighter">
                            Neural
                        </div>
                    </div>
                    <div className="mt-12 flex justify-center items-center gap-2 text-slate-400 font-bold text-xs uppercase tracking-widest">
