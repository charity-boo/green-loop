...
import { AlertCircle, UserPlus, BookOpen, Coins } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-white">
            <div className="px-6 py-8 max-w-[1400px] mx-auto space-y-12">
                ...
                {nextPickup ? (
                    <div className="bg-green-600 p-8 rounded-2xl text-white shadow-lg shadow-green-200">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button className="text-green-100 text-sm font-semibold hover:text-white transition-colors">
                                Cancel Pickup
                            </button>
                        </div>
                    </div>
                ) : (
                    <div className="bg-white border-2 border-green-100 p-10 rounded-2xl text-center">
                        ...
                        <Link href="/schedule-pickup" className="bg-green-600 text-white px-8 py-3 rounded-xl font-bold text-sm hover:bg-green-700 transition-colors inline-block shadow-lg shadow-green-200">
                            Schedule Now
                        </Link>
                    </div>
                )}
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        ...
                        <div className="pt-4">
                            ...
                            <div className="space-y-4">
                                <Link href="/contact" className="flex items-center gap-3 text-slate-600 hover:text-green-600 transition-colors group">
                                ...
                                <Link href="/referral" className="flex items-center gap-3 text-slate-600 hover:text-green-600 transition-colors group">
                                    <div className="p-2 rounded-lg bg-green-50 text-green-500 group-hover:bg-green-100 transition-colors">
                                ...
                                <Link href="/learning-hub" className="flex items-center gap-3 text-slate-600 hover:text-green-600 transition-colors group">
                                    <div className="p-2 rounded-lg bg-green-50 text-green-500 group-hover:bg-green-100 transition-colors">
                                ...
                                <Link href="/dashboard/green-points" className="flex items-center gap-3 text-slate-600 hover:text-green-600 transition-colors group">
                                    <div className="p-2 rounded-lg bg-green-50 text-green-500 group-hover:bg-green-100 transition-colors">
                                        <Coins className="h-4 w-4" />
                                    </div>
                                    <span className="text-sm font-semibold">Rewards Center</span>
                                </Link>
                            </div>
                        </div>
                    </div>
