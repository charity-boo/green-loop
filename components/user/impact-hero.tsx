            ...
            <div className="flex flex-wrap items-center gap-8 mt-6">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-lg font-bold text-green-600 leading-none">{Math.round(totalWeight)}kg</p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
                    <div className="p-2 rounded-lg bg-green-50 text-green-600">
                    ...
                    <div>
                        ...
                        <p className="text-lg font-bold text-green-600 leading-none">{currentPoints}</p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
                    <div className="p-2 rounded-lg bg-green-50 text-green-600">
                    ...
                    <div>
                        ...
                        <p className="text-lg font-bold text-green-600 leading-none">{Math.round(co2Saved)}kg</p>
                    </div>
                </div>
            </div>
        </div>
