  ...
  return (
    <div className="mt-12 p-6 bg-green-100 border border-green-300 rounded-xl shadow-lg w-full max-w-lg mx-auto text-center">
      <h3 className="text-xl font-bold text-green-800 mb-3">
        {user ? "You are logged in" : "Ready to Implement Smart Waste Management?"}
      </h3>
      <p className="text-gray-700 mb-4">
        {user ? "You can now schedule a consultation." : "Login to schedule a consultation or register your institution now."}
      </p>
