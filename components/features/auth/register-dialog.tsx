  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogTrigger asChild>
        <Button
          className="bg-green-600 hover:bg-green-700 text-white shadow-md transition duration-200"
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="flex items-center space-x-4 p-4 border border-green-200 rounded-lg bg-green-50">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Create an account in minutes.</p>
            </div>
          ...
          <div className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Welcome back! Sign in here.</p>
            </div>
            <Link href="/auth/login" passHref className="ml-auto">
              <Button variant="outline" className="text-gray-700 border-gray-300 hover:bg-muted/50" onClick={() => setIsOpen(false)}>
                Login
              </Button>
            </Link>
          </div>
